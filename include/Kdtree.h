...
private:
        ...
        Node _parent;
public:
        explicit Kdtree ( void ) : _numElement( 0 ), _numMaxElementsPerNode( 10 )
        {
                return;
        }

        explicit Kdtree ( std::vector<T>& point, const size_t numMaxElementsPerNode = 10 )
        {
                this->build ( point, numMaxElementsPerNode );
                return;
        }
        ...
        bool build ( std::vector<T>& point, const size_t numMaxElementsPerNode = 10 )
        {
